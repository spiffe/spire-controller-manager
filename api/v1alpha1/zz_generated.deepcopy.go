...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SyncTypesConfig) DeepCopyInto(out *SyncTypesConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SyncTypesConfig.
func (in *SyncTypesConfig) DeepCopy() *SyncTypesConfig {
	if in == nil {
		return nil
	}
	out := new(SyncTypesConfig)
