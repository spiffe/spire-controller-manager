...
func TestComputeEndpointsRV(t *testing.T) {
	t.Run("empty list", func(t *testing.T) {
		...
		assert.Equal(t, "", computeEndpointsRV([]corev1.Endpoints{})) //nolint:staticcheck // deprecated, will be replaced by discoveryv1.EndpointSlice
	})

	t.Run("single endpoint", func(t *testing.T) {
		items := []corev1.Endpoints{ //nolint:staticcheck // deprecated, will be replaced by discoveryv1.EndpointSlice
	...
	t.Run("RV change produces different result", func(t *testing.T) {
		before := []corev1.Endpoints{ //nolint:staticcheck // deprecated, will be replaced by discoveryv1.EndpointSlice
			{ObjectMeta: metav1.ObjectMeta{ResourceVersion: "100"}},
		}
		after := []corev1.Endpoints{ //nolint:staticcheck // deprecated, will be replaced by discoveryv1.EndpointSlice
