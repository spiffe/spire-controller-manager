...
| Field                          | Required | Default | Description                                                                                                                                                                                                 |
|--------------------------------|----------|---------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `tlsConfig.minTLSVersion`     | OPTIONAL | TLS 1.2 | Minimum TLS version in Kubernetes-style naming (for example `VersionTLS12`, `VersionTLS13`). Values below TLS 1.2 are raised to TLS 1.2. TLS 1.3 connections may still be negotiated when the minimum is TLS 1.2.                                                                          |
